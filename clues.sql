...
--  Southern Europe. She's most likely traveling someplace where she won't be noticed, so find the least
--  populated country in Southern Europe, and we'll start looking for her there.
 
-- Write SQL query here
SELECT code, name, population
FROM countries
WHERE code IN ('ALB', 'AND', 'BIH', 'ESP', 'GRC', 'HRV', 'ITA', 'MKD', 'MLT', 'PRT', 'SMR', 'SVN', 'VAT', 'YUG')
